...
XS(boot_Hypergeom)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXS("Hypergeom::constant", XS_Hypergeom_constant, file);
        (void)newXS("Hypergeom::cumhyper", XS_Hypergeom_cumhyper, file);
        (void)newXS("Hypergeom::lcumhyper", XS_Hypergeom_lcumhyper, file);
        (void)newXS("Hypergeom::cumbino", XS_Hypergeom_cumbino, file);
        (void)newXS("Hypergeom::bino", XS_Hypergeom_bino, file);
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
